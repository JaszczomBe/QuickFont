...
namespace Example
{
    class Game : GameWindow
    {
        ...
        protected override void OnLoad()
        {
            ...
            _processedText = QFontDrawingPrimitive.ProcessText(_mainText, _mainTextOptions, _preProcessed, new SizeF(this.Size.X - 40, -1), QFontAlignment.Left);
        ...
        protected override void OnResize(ResizeEventArgs e)
        {
            ...
            _projectionMatrix = Matrix4.CreateOrthographicOffCenter(ClientRectangle.Min.X, ClientRectangle.Size.X, ClientRectangle.Min.Y, ClientRectangle.Size.Y, -1.0f, 1.0f);
        }
        ...
        private void PrintWithBounds(QFont font, string text, RectangleF bounds, QFontAlignment alignment, ref float yOffset)
        {
            ...
            dp.Print(text, new Vector3(bounds.X, this.Size.Y - yOffset, 0), new SizeF(maxWidth, float.MaxValue), alignment);
        ...
        {
            yOffset += 20;
            var pos = new Vector3(30f, this.Size.Y - yOffset, 0f);
            var dp = new QFontDrawingPrimitive(font, opts ?? new QFontRenderOptions());
            dp.Print(comment, pos, new SizeF(this.Size.X - 60, -1), alignment);
            yOffset += dp.Measure(comment, new SizeF(this.Size.X - 60, -1), alignment).Height;
            _drawing.DrawingPrimitives.Add(dp);
        }
        ...
        private void PrintCommentWithLine(QFont font, string comment, QFontAlignment alignment, float xOffset, ref float yOffset, QFontRenderOptions opts)
        {
            ...
            dp.Print(comment, new Vector3(xOffset, this.Size.Y - yOffset, 0f), new SizeF(this.Size.X - 60, -1), alignment);
            _drawing.DrawingPrimitives.Add(dp);
            var bounds = font.Measure(comment, new SizeF(this.Size.X - 60, float.MaxValue), alignment);
        ...
        {
            yOffset += 20;
            var pos = new Vector3(50f, this.Size.Y - yOffset, 0f);
            _drawing.Print(_codeText, code, pos, new SizeF(this.Size.X - 50, -1), QFontAlignment.Left, _codeTextOptions);
            yOffset += _codeText.Measure(code, new SizeF(this.Size.X - 50, -1), QFontAlignment.Left).Height;
        }
        ...
        protected override void OnRenderFrame(FrameEventArgs e)
        {
            ...
            if (_currentDemoPage != _previousPage)
            {
                ...
                switch (_currentDemoPage)
                {
                    case 0:
                        {
                            yOffset += _drawing.Print(_heading1, "ModernQuickFont",
                                                                     new Vector3((float)this.Size.X / 2, this.Size.Y, 0),
                                                                     QFontAlignment.Centre, _heading1Options).Height;

                            yOffset += _drawing.Print(_heading2, "Introduction #0",
                                                                     new Vector3(20, this.Size.Y - yOffset, 0),
                                                                     QFontAlignment.Left, _heading2Options)
                                        .Height;

                            yOffset += _drawing.Print(_mainText, _modernQuickFontIntro, new Vector3(30, this.Size.Y - yOffset, 0),
                                                                 new SizeF(this.Size.X - 60f, -1), QFontAlignment.Left).Height;
                    ...
                    case 1:
                        {
                            ...
                            yOffset += 20f;
                            _drawing.Print(_mainText, _introduction, new Vector3(30, this.Size.Y - yOffset, 0),
                                                                 new SizeF(this.Size.X - 60f, -1), QFontAlignment.Justify);
                    ...
                    case 2:
                        {
                            yOffset += _drawing.Print(_heading2, "Easy as ABC!",
                                                                     new Vector3(20f, this.Size.Y - yOffset, 0f),
                    ...
                    case 3:
                        {
                            yOffset += _drawing.Print(_heading2, "Alignment", new Vector3(20f, this.Size.Y - yOffset, 0f),
                                                                     QFontAlignment.Left, _heading2Options).Height;
                            ...
                            PrintCommentWithLine(_centredTextAsYou, QFontAlignment.Centre, this.Size.X * 0.5f, ref yOffset);
                    ...
                    case 4:
                        {
                            ...
                            yOffset += _drawing.Print(_controlsText, "Press [Up], [Down] or [Enter]!",
                                                                         new Vector3(this.Size.X * 0.5f, this.Size.Y - yOffset, 0f),
                            ...
                            PrintWithBounds(_mainText, _ofCourseItsNot,
                                            new RectangleF(30f + boundShrink * 0.5f, yOffset, this.Size.X - 60 - boundShrink,
                    ...
                    case 8:
                        {
                            ...
                            yOffset += 2f;
                            PrintCommentWithLine(_monoSpaced, _mono, QFontAlignment.Centre, this.Size.X * 0.5f, ref yOffset, monoSpaceCondensed);
                            yOffset += 2f;
                    ...
                    case 9:
                        {
                            ...
                            yOffset += _drawing.Print(_mainText, _processedText,
                                                                     new Vector3(20, this.Size.Y - yOffset, 0)).Height;
                            _stopwatch.Stop();
                            ...
                            yOffset += _drawing.Print(_mainText, _nonPreProcessed,
                                                                     new Vector3(20, this.Size.Y - yOffset, 0),
                                                                     new SizeF(this.Size.X - 40f, -1), QFontAlignment.Left)
                                        .Height;
                            _stopwatch.Stop();
                            ...
                            _drawing.Print(_benchmarkResults, _benchResult,
                                                                          new Vector3(this.Size.X * 0.5f, this.Size.Y - yOffset, 0),
                    ...
                    case 11:
                        {
                            ...
                            foreach (var qFont in _installedFonts)
                            {
                                yOffset += _drawing.Print(qFont, "This text is printed with " + qFont.FontName,
                                    new Vector3(20f, this.Size.Y - yOffset, 0), QFontAlignment.Left, Color.White).Height + 10;
                            }
            ...
            if (_currentDemoPage != _lastPage)
            {
                ...
                Vector3 pos = new Vector3(this.Size.X - dim.Width / 2 - 16 * (float)(1 + Math.Sin(_cnt * 4)),
        ...
        static void Main()
        {
            ...
            gs.RenderFrequency = 60;

            var ns = new NativeWindowSettings();
            ns.Size = new Vector2i(800, 600);
            ns.Title = "QuickFont Example";

            using (Game game = new Game(gs, ns))
            {
                game.Run();
            }
        }
